...
class HospitalListAdaptor extends BaseAdapter {
    ...
    public HospitalListAdaptor(Context context, String[] data, int[] images) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View vi = convertView;
        if (vi == null)
            vi = inflater.inflate(R.layout.hospitalitem, null);
